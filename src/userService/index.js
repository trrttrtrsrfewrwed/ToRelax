let data = [
    {user: {login: "trrttrtrsrfewrwed", email: "nurgaliev.tr@phystech.edu"},
     ...
     {id: 2, name: "Пошутить", category: "outdoors", description: "Смешно пошутить", time: "00:05", rating: 5, minimized: true},
     {id: 3, name: "Пошутить", category: "outdoors", description: "Смешно пошутить", time: "00:05", rating: 5, minimized: true},
     {id: 4, name: "Пошутить", category: "outdoors", description: "Смешно пошутить", time: "00:05", rating: 5, minimized: true},
     {id: 5, name: "Пошутить", category: "outdoors", description: "Смешно пошутить", time: "00:05", rating: 5, minimized: true},
     {id: 6, name: "Пошутить", category: "outdoors", description: "Смешно пошутить", time: "00:03", rating: 4, minimized: true},
     {id: 7, name: "Пошутить", category: "outdoors", description: "Смешно пошутить", time: "00:03", rating: 4, minimized: true}]}
]
